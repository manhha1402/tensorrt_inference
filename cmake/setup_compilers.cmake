...
# header files Useful for neura_surface_matching PyTorch wrapper, which requires the old
# Pre-CXX11 ABI
...
set(neura_surface_matching_link_options "-Wl,--disable-new-dtags")
...
# Change namespace cub:: into neura_surface_matching::cub. This is to avoid conflicts when other modules calls non
# thread safe functions in the cub namespace. Appending neura_surface_matching:: ensures an unique symbol that is
# only accesed by this library.
#add_compile_definitions(CUB_WRAPPED_NAMESPACE=neura_surface_matching)
...
if (USE_SANITIZER)
  ...
  set(neura_surface_matching_link_options "${neura_surface_matching_link_options}" "-fsanitize=address")
endif(USE_SANITIZER)
